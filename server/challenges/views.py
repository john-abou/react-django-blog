...
def monthly_challenge_template(req, month):
    try: 
        challenge_text = monthly_challenges[month]
        response_data = render_to_string('challenges/challenge.html', {
            'text': challenge_text, # Note, the key is the name of the variable in the template
            'month_name': month.capitalize() # Note, the key is the name of the variable in the template
        })
